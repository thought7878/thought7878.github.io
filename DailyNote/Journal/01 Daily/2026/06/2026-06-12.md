---
created: 2026-06-12 09:09
updated: 2026-06-12 09:09
aliases:
tags:
  - "#daily-note"
log-sleep-hours:
...
- [ ] 前端架构 [created:: 2025-08-20T07:50:45] [start:: 2025-08-20T07:50:49] [🍅:: 750]  ^l9dh
- [ ] 学习AI编程 [🍅:: 22] ^f94p
...
const today = dt.fromISO("2026-06-12");
...
```dataviewjs
const today = new Date("2026-06-12"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2026-06-12").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: 前端架构 [created:: 2025-08-20T07:50:45] [start:: 2025-08-20T07:50:49]) (blockLinkId::  ^l9dh) (duration:: 25m) (begin:: 2026-06-12T09:10) - (end:: 2026-06-12T09:35)
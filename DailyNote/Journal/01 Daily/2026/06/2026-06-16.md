...
const today = dt.fromISO("2026-06-16");
...
```dataviewjs
const today = new Date("2026-06-16"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2026-06-16").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: 建立系统 [created:: 2025-05-25T08:22:16] [start:: 2025-05-25T08:22:20]) (blockLinkId::  ^qv8k) (duration:: 25m) (begin:: 2026-06-16T17:20) - (end:: 2026-06-16T17:45)
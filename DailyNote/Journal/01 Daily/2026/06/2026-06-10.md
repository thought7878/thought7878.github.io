---
created: 2026-06-10 15:07
updated: 2026-06-10 15:07
aliases:
tags:
  - "#daily-note"
log-sleep-hours:
...
const today = dt.fromISO("2026-06-10");
...
```dataviewjs
const today = new Date("2026-06-10"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2026-06-10").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: 学习AI编程) (blockLinkId::  ^f94p) (duration:: 25m) (begin:: 2026-06-10T15:08) - (end:: 2026-06-10T17:15)
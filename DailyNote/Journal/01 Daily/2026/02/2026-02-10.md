---
created: 2026-02-10 09:02
updated: 2026-02-10 09:02
aliases:
tags:
  - "#daily-note"
log-sleep-hours:
...
const today = dt.fromISO("2026-02-10");
...
```dataviewjs
const today = new Date("2026-02-10"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2026-02-10").toISODate()
```
...
🟡 (pomodoro:: Unfinished) (taskName:: ) (blockLinkId:: ) (duration:: 8m) (begin:: 2026-02-04T09:53) - (end:: 2026-02-10T09:02)
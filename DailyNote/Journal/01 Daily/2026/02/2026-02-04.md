---
created: 2026-02-04 09:52
updated: 2026-02-04 09:52
aliases:
tags:
  - "#daily-note"
log-sleep-hours:
...
const today = dt.fromISO("2026-02-04");
...
```dataviewjs
const today = new Date("2026-02-04"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2026-02-04").toISODate()
```

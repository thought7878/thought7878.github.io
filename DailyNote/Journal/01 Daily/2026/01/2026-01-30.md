---
created: 2026-01-30 08:43
updated: 2026-01-30 08:43
aliases:
tags:
  - "#daily-note"
log-sleep-hours:
...
- [ ] 构建工程化的知识树 [🍅:: 97] ^z1m2
- [ ] 1道算法题 [🍅:: 130] ^s73r
- [ ] react源码 [created:: 2026-01-05T08:14:59] [start:: 2026-01-05T08:15:03] [🍅:: 202]  ^mcv8
...
const today = dt.fromISO("2026-01-30");
...
```dataviewjs
const today = new Date("2026-01-30"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2026-01-30").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: react源码 [created:: 2026-01-05T08:14:59] [start:: 2026-01-05T08:15:03]) (blockLinkId::  ^mcv8) (duration:: 25m) (begin:: 2026-01-30T08:43) - (end:: 2026-01-30T09:52)
🍅 (pomodoro:: WORK) (taskName:: react源码 [created:: 2026-01-05T08:14:59] [start:: 2026-01-05T08:15:03]) (blockLinkId::  ^mcv8) (duration:: 25m) (begin:: 2026-01-30T10:02) - (end:: 2026-01-30T10:27)
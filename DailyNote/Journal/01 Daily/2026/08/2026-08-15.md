---
created: 2026-08-15 13:23
updated: 2026-08-15 13:23
aliases:
tags:
  - "#daily-note"
log-sleep-hours:
...
const today = dt.fromISO("2026-08-15");
...
```dataviewjs
const today = new Date("2026-08-15"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2026-08-15").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: 学习AI编程) (blockLinkId::  ^f94p) (duration:: 25m) (begin:: 2026-08-15T13:23) - (end:: 2026-08-15T13:48)
🍅 (pomodoro:: WORK) (taskName:: 学习AI编程) (blockLinkId::  ^f94p) (duration:: 25m) (begin:: 2026-08-15T14:58) - (end:: 2026-08-15T15:39)
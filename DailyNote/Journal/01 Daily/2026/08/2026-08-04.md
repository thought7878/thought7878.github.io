...
const today = dt.fromISO("2026-08-04");
...
```dataviewjs
const today = new Date("2026-08-04"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2026-08-04").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: 前端架构 [created:: 2025-08-20T07:50:45] [start:: 2025-08-20T07:50:49]) (blockLinkId::  ^l9dh) (duration:: 25m) (begin:: 2026-08-04T16:02) - (end:: 2026-08-04T16:37)
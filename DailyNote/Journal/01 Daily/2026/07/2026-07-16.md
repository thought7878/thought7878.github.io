---
created: 2026-07-16 16:20
updated: 2026-07-16 16:20
aliases:
tags:
  - "#daily-note"
log-sleep-hours:
...
- [ ] 前端架构 [created:: 2025-08-20T07:50:45] [start:: 2025-08-20T07:50:49] [🍅:: 838]  ^l9dh
- [ ] 学习AI编程 [🍅:: 22] ^f94p
...
const today = dt.fromISO("2026-07-16");
...
```dataviewjs
const today = new Date("2026-07-16"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2026-07-16").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: 前端架构 [created:: 2025-08-20T07:50:45] [start:: 2025-08-20T07:50:49]) (blockLinkId::  ^l9dh) (duration:: 25m) (begin:: 2026-07-16T16:20) - (end:: 2026-07-16T16:45)
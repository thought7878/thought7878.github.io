---
created: 2026-04-23 08:12
updated: 2026-04-23 08:12
aliases:
tags:
  - "#daily-note"
log-sleep-hours:
...
const today = dt.fromISO("2026-04-23");
...
```dataviewjs
const today = new Date("2026-04-23"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2026-04-23").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: ) (blockLinkId:: ) (duration:: 25m) (begin:: 2026-04-23T08:12) - (end:: 2026-04-23T10:21)
🍅 (pomodoro:: WORK) (taskName:: ) (blockLinkId:: ) (duration:: 25m) (begin:: 2026-04-23T17:26) - (end:: 2026-04-23T17:51)
🍅 (pomodoro:: WORK) (taskName:: ) (blockLinkId:: ) (duration:: 25m) (begin:: 2026-04-23T17:52) - (end:: 2026-04-23T21:27)
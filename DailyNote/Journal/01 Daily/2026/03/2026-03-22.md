---
created: 2026-03-22 09:58
updated: 2026-03-22 09:58
aliases:
tags:
  - "#daily-note"
log-sleep-hours:
...
const today = dt.fromISO("2026-03-22");
...
```dataviewjs
const today = new Date("2026-03-22"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2026-03-22").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: react源码 [created:: 2026-01-05T08:14:59] [start:: 2026-01-05T08:15:03]) (blockLinkId::  ^mcv8) (duration:: 25m) (begin:: 2026-03-22T09:58) - (end:: 2026-03-22T10:23)
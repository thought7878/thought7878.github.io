---
created: 2025-06-12 07:36
updated: 2025-06-12 07:36
aliases: 
tags:
  - "#daily-note"
log-sleep-hours: 
...
- [ ] number input [created:: 2025-06-08T08:30:51] [start:: 2025-06-08T08:30:55] [🍅:: 4]  ^5pfi
...
const today = dt.fromISO("2025-06-11");
...
```dataviewjs
const today = new Date("2025-06-11"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-06-11").toISODate()
```

---
created: 2025-06-07 09:24
updated: 2025-06-07 09:24
aliases: 
tags:
  - "#daily-note"
log-sleep-hours: 
...
const today = dt.fromISO("2025-06-07");
...
```dataviewjs
const today = new Date("2025-06-07"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-06-07").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: 开源代码 [created:: 2025-06-06T10:09:10] [start:: 2025-06-06T10:09:14]) (blockLinkId::  ^oa09) (duration:: 25m) (begin:: 2025-06-07T09:25) - (end:: 2025-06-07T09:50)
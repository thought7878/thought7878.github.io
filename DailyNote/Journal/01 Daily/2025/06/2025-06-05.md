---
created: 2025-06-05 13:25
updated: 2025-06-05 13:25
aliases: 
tags:
  - "#daily-note"
log-sleep-hours: 
...
const today = dt.fromISO("2025-06-05");
...
```dataviewjs
const today = new Date("2025-06-05"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-06-05").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: day-picker [created:: 2025-05-28T10:15:31] [start:: 2025-05-28T10:15:35]) (blockLinkId::  ^bp3s) (duration:: 25m) (begin:: 2025-06-05T13:27) - (end:: 2025-06-05T13:52)
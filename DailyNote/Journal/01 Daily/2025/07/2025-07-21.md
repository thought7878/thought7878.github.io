---
created: 2025-07-21 09:01
updated: 2025-07-21 09:01
aliases: 
tags:
  - "#daily-note"
log-sleep-hours: 
...
const today = dt.fromISO("2025-07-21");
...
```dataviewjs
const today = new Date("2025-07-21"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-07-21").toISODate()
```

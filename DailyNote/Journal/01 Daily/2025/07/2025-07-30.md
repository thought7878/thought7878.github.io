---
created: 2025-07-30 08:42
updated: 2025-07-30 08:42
aliases: 
tags:
  - "#daily-note"
log-sleep-hours: 
...
const today = dt.fromISO("2025-07-30");
...
```dataviewjs
const today = new Date("2025-07-30"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-07-30").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: 面试、简历) (blockLinkId::  ^kvda) (duration:: 25m) (begin:: 2025-07-30T09:47) - (end:: 2025-07-30T10:12)
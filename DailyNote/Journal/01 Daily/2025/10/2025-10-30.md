---
created: 2025-10-30 09:02
updated: 2025-10-30 09:02
aliases:
tags:
  - "#daily-note"
log-sleep-hours:
...
const today = dt.fromISO("2025-10-30");
...
```dataviewjs
const today = new Date("2025-10-30"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-10-30").toISODate()
```
...
🟡 (pomodoro:: Unfinished) (taskName:: ) (blockLinkId:: ) (duration:: 9m) (begin:: 2025-10-29T16:43) - (end:: 2025-10-30T09:02)
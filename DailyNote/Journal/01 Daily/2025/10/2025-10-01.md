---
created: 2025-10-01 08:55
updated: 2025-10-01 08:55
aliases:
tags:
  - "#daily-note"
log-sleep-hours:
...
- [ ] 前端架构 [created:: 2025-08-20T07:50:45] [start:: 2025-08-20T07:50:49] [🍅:: 223]  ^l9dh
...
const today = dt.fromISO("2025-10-01");
...
```dataviewjs
const today = new Date("2025-10-01"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-10-01").toISODate()
```
...
🟡 (pomodoro:: Unfinished) (taskName:: 前端架构 [created:: 2025-08-20T07:50:45] [start:: 2025-08-20T07:50:49]) (blockLinkId::  ^l9dh) (duration:: 6m) (begin:: 2025-09-30T16:58) - (end:: 2025-10-01T08:56)
---
created: 2025-10-02 07:39
updated: 2025-10-02 07:39
aliases:
tags:
  - "#daily-note"
log-sleep-hours:
...
- [ ] 前端架构 [created:: 2025-08-20T07:50:45] [start:: 2025-08-20T07:50:49] [🍅:: 225]  ^l9dh
- [ ] 学习AI编程 [🍅:: 2] ^f94p
...
const today = dt.fromISO("2025-10-02");
...
```dataviewjs
const today = new Date("2025-10-02"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-10-02").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: 学习AI编程) (blockLinkId::  ^f94p) (duration:: 25m) (begin:: 2025-10-02T08:18) - (end:: 2025-10-02T08:43)
🍅 (pomodoro:: WORK) (taskName:: 学习AI编程) (blockLinkId::  ^f94p) (duration:: 25m) (begin:: 2025-10-02T08:59) - (end:: 2025-10-02T09:24)
---
created: 2025-04-13 15:27
updated: 2025-04-13 15:27
aliases: 
tags:
  - "#daily-note"
log-sleep-hours: 
...
- [ ] Event Loop, Web APIs, (Micro)task Queue [start:: 2025-04-13T16:38:26] [🍅:: 2]   ^z51q
...
const today = dt.fromISO("2025-04-13");
...
```dataviewjs
const today = new Date("2025-04-13"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-04-13").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: ) (blockLinkId:: ) (duration:: 25m) (begin:: 2025-04-13T15:30) - (end:: 2025-04-13T15:55)
🍅 (pomodoro:: WORK) (taskName:: Event Loop, Web APIs, (Micro)task Queue [start:: 2025-04-13T16:38:26]) (blockLinkId::  ^z51q) (duration:: 25m) (begin:: 2025-04-13T16:36) - (end:: 2025-04-13T17:01)
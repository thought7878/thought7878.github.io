---
created: 2025-04-18 09:12
updated: 2025-04-18 09:12
aliases: 
tags:
  - "#daily-note"
log-sleep-hours: 
...
const today = dt.fromISO("2025-04-18");
...
```dataviewjs
const today = new Date("2025-04-18"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-04-18").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: ) (blockLinkId:: ) (duration:: 25m) (begin:: 2025-04-18T09:15) - (end:: 2025-04-18T09:40)
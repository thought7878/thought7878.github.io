---
created: 2025-04-17 08:47
updated: 2025-04-17 08:47
aliases: 
tags:
  - "#daily-note"
log-sleep-hours: 
...
const today = dt.fromISO("2025-04-17");
...
```dataviewjs
const today = new Date("2025-04-17"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-04-17").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: 整理JS知识点) (blockLinkId::  ^uz0e) (duration:: 25m) (begin:: 2025-04-17T08:50) - (end:: 2025-04-17T09:15)
---
created: 2025-04-02 08:45
updated: 2025-04-02 08:45
aliases: 
tags:
  - "#daily-note"
log-sleep-hours: 
...
- [ ] 执行上下文 [start:: 2025-04-02T08:45:44]  [🍅:: 5] ^5pkn
- [ ] 变量环境 
- [ ] 词法环境
- [ ] 整理JS知识点 [🍅:: 16] ^uz0e
...
const today = dt.fromISO("2025-04-02");
...
```dataviewjs
const today = new Date("2025-04-02"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-04-02").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: 执行上下文 [start:: 2025-04-02T08:45:44]) (blockLinkId::  ^5pkn) (duration:: 25m) (begin:: 2025-04-02T08:50) - (end:: 2025-04-02T09:15)
🍅 (pomodoro:: WORK) (taskName:: 执行上下文 [start:: 2025-04-02T08:45:44]) (blockLinkId::  ^5pkn) (duration:: 25m) (begin:: 2025-04-02T10:27) - (end:: 2025-04-02T11:21)
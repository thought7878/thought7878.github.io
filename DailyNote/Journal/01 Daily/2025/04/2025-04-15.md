---
created: 2025-04-15 16:04
updated: 2025-04-15 16:04
aliases: 
tags:
  - "#daily-note"
log-sleep-hours: 
...
---
# 习惯
- [睡眠开始时间:: 2025-04-16T01:05:58] [睡眠结束时间:: 2025-04-16T07:10:46] [睡眠分数:: 79] [睡眠原因:: 睡得晚] 
- [运动类型:: 骑动感单车] [运动时间:: ]
- [睡前冥想:: true]
...
const today = dt.fromISO("2025-04-15");
...
```dataviewjs
const today = new Date("2025-04-15"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-04-15").toISODate()
```

---
created: 2025-05-08 08:41
updated: 2025-05-08 08:41
aliases: 
tags:
  - "#daily-note"
log-sleep-hours: 
...
- [ ] React 源码 [created:: 2025-04-21T09:10:36]  [start:: 2025-04-21T09:10:38] [🍅:: 47]  ^1kfr
...
const today = dt.fromISO("2025-05-08");
...
```dataviewjs
const today = new Date("2025-05-08"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-05-08").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: React 源码 [created:: 2025-04-21T09:10:36]  [start:: 2025-04-21T09:10:38]) (blockLinkId::  ^1kfr) (duration:: 25m) (begin:: 2025-05-08T08:42) - (end:: 2025-05-08T09:07)
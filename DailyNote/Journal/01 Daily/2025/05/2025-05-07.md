---
created: 2025-05-07 17:46
updated: 2025-05-07 17:46
aliases: 
tags:
  - "#daily-note"
log-sleep-hours: 
...
const today = dt.fromISO("2025-05-07");
...
```dataviewjs
const today = new Date("2025-05-07"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-05-07").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: 个人成长：懒人高效学编程：20%努力80%成果) (blockLinkId::  ^vg56) (duration:: 25m) (begin:: 2025-05-07T15:02) - (end:: 2025-05-07T15:27)
🍅 (pomodoro:: WORK) (taskName:: React 源码 [created:: 2025-04-21T09:10:36]  [start:: 2025-04-21T09:10:38]) (blockLinkId::  ^1kfr) (duration:: 25m) (begin:: 2025-05-07T17:46) - (end:: 2025-05-07T18:11)
---
created: 2025-05-25 08:16
updated: 2025-05-25 08:16
aliases: 
tags:
  - "#daily-note"
log-sleep-hours: 
...
- [ ] 建立系统 [created:: 2025-05-25T08:22:16] [start:: 2025-05-25T08:22:20] [🍅:: 1]  ^qv8k
...
const today = dt.fromISO("2025-05-25");
...
```dataviewjs
const today = new Date("2025-05-25"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-05-25").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: 建立系统[created:: 2025-05-25T08:22:16] [start:: 2025-05-25T08:22:20]) (blockLinkId::  ^qv8k) (duration:: 25m) (begin:: 2025-05-25T08:22) - (end:: 2025-05-25T08:47)
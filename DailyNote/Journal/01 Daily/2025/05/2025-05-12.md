---
created: 2025-05-12 07:19
updated: 2025-05-12 07:19
aliases: 
tags:
  - "#daily-note"
log-sleep-hours: 
...
- [ ] React 源码 [created:: 2025-04-21T09:10:36]  [start:: 2025-04-21T09:10:38] [🍅:: 62]  ^1kfr
...
const today = dt.fromISO("2025-05-12");
...
```dataviewjs
const today = new Date("2025-05-12"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-05-12").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: React 源码 [created:: 2025-04-21T09:10:36]  [start:: 2025-04-21T09:10:38]) (blockLinkId::  ^1kfr) (duration:: 25m) (begin:: 2025-05-12T07:20) - (end:: 2025-05-12T07:45)
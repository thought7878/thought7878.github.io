---
created: 2025-12-23 07:42
updated: 2025-12-23 07:42
aliases:
tags:
  - "#daily-note"
log-sleep-hours:
...
const today = dt.fromISO("2025-12-23");
...
```dataviewjs
const today = new Date("2025-12-23"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-12-23").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: ) (blockLinkId:: ) (duration:: 25m) (begin:: 2025-12-23T10:18) - (end:: 2025-12-23T10:46)
🍅 (pomodoro:: WORK) (taskName:: ) (blockLinkId:: ) (duration:: 25m) (begin:: 2025-12-23T14:30) - (end:: 2025-12-23T16:43)
...
const today = dt.fromISO("2025-12-09");
...
```dataviewjs
const today = new Date("2025-12-09"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-12-09").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: 构建工程化的知识树) (blockLinkId::  ^z1m2) (duration:: 25m) (begin:: 2025-12-09T09:04) - (end:: 2025-12-09T09:29)
🍅 (pomodoro:: WORK) (taskName:: 构建工程化的知识树) (blockLinkId::  ^z1m2) (duration:: 25m) (begin:: 2025-12-09T15:19) - (end:: 2025-12-09T16:56)
🍅 (pomodoro:: WORK) (taskName:: 构建工程化的知识树) (blockLinkId::  ^z1m2) (duration:: 25m) (begin:: 2025-12-09T20:43) - (end:: 2025-12-09T21:08)
---
created: 2025-12-31 09:13
updated: 2025-12-31 09:13
aliases:
tags:
  - "#daily-note"
log-sleep-hours:
...
- [ ] 前端架构 [created:: 2025-08-20T07:50:45] [start:: 2025-08-20T07:50:49] [🍅:: 393]  ^l9dh
- [ ] 学习AI编程 [🍅:: 4] ^f94p
...
const today = dt.fromISO("2025-12-31");
...
```dataviewjs
const today = new Date("2025-12-31"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-12-31").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: 前端架构 [created:: 2025-08-20T07:50:45] [start:: 2025-08-20T07:50:49]) (blockLinkId::  ^l9dh) (duration:: 25m) (begin:: 2025-12-31T09:13) - (end:: 2025-12-31T09:39)
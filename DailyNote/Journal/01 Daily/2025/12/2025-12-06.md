---
created: 2025-12-06 09:25
updated: 2025-12-06 09:25
aliases:
tags:
  - "#daily-note"
log-sleep-hours:
...
const today = dt.fromISO("2025-12-06");
...
```dataviewjs
const today = new Date("2025-12-06"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-12-06").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: 构建工程化的知识树) (blockLinkId::  ^z1m2) (duration:: 25m) (begin:: 2025-12-06T09:46) - (end:: 2025-12-06T10:11)
🍅 (pomodoro:: WORK) (taskName:: 构建工程化的知识树) (blockLinkId::  ^z1m2) (duration:: 25m) (begin:: 2025-12-06T10:20) - (end:: 2025-12-06T10:45)
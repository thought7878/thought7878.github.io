---
created: 2025-09-27 07:20
updated: 2025-09-27 07:20
aliases:
tags:
  - "#daily-note"
log-sleep-hours:
...
- [ ] 前端架构 [created:: 2025-08-20T07:50:45] [start:: 2025-08-20T07:50:49] [🍅:: 216]  ^l9dh
...
const today = dt.fromISO("2025-09-27");
...
```dataviewjs
const today = new Date("2025-09-27"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-09-27").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: 前端架构 [created:: 2025-08-20T07:50:45] [start:: 2025-08-20T07:50:49]) (blockLinkId::  ^l9dh) (duration:: 25m) (begin:: 2025-09-27T07:21) - (end:: 2025-09-27T08:50)
🍅 (pomodoro:: WORK) (taskName:: 前端架构 [created:: 2025-08-20T07:50:45] [start:: 2025-08-20T07:50:49]) (blockLinkId::  ^l9dh) (duration:: 25m) (begin:: 2025-09-27T14:46) - (end:: 2025-09-27T17:49)
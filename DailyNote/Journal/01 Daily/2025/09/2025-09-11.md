---
created: 2025-09-11 07:20
updated: 2025-09-11 07:20
aliases: 
tags:
  - "#daily-note"
log-sleep-hours: 
...
const today = dt.fromISO("2025-09-11");
...
```dataviewjs
const today = new Date("2025-09-11"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-09-11").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: ) (blockLinkId:: ) (duration:: 25m) (begin:: 2025-09-11T07:20) - (end:: 2025-09-11T07:45)
🍅 (pomodoro:: WORK) (taskName:: ) (blockLinkId:: ) (duration:: 25m) (begin:: 2025-09-11T07:59) - (end:: 2025-09-11T08:24)
🍅 (pomodoro:: WORK) (taskName:: ) (blockLinkId:: ) (duration:: 25m) (begin:: 2025-09-11T20:35) - (end:: 2025-09-11T21:00)
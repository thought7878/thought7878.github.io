---
created: 2025-11-16 07:41
updated: 2025-11-16 07:41
aliases:
tags:
  - "#daily-note"
log-sleep-hours:
...
const today = dt.fromISO("2025-11-16");
...
```dataviewjs
const today = new Date("2025-11-16"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-11-16").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: 1道算法题) (blockLinkId::  ^s73r) (duration:: 25m) (begin:: 2025-11-16T07:42) - (end:: 2025-11-16T08:07)
🍅 (pomodoro:: WORK) (taskName:: 1道算法题) (blockLinkId::  ^s73r) (duration:: 25m) (begin:: 2025-11-16T08:58) - (end:: 2025-11-16T09:23)
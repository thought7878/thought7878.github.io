---
created: 2025-11-08 08:18
updated: 2025-11-08 08:18
aliases:
tags:
  - "#daily-note"
log-sleep-hours:
...
const today = dt.fromISO("2025-11-08");
...
```dataviewjs
const today = new Date("2025-11-08"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-11-08").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: 1道算法题) (blockLinkId::  ^s73r) (duration:: 25m) (begin:: 2025-11-08T08:19) - (end:: 2025-11-08T09:37)
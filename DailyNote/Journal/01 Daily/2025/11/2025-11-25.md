...
const today = dt.fromISO("2025-11-25");
...
```dataviewjs
const today = new Date("2025-11-25"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-11-25").toISODate()
```

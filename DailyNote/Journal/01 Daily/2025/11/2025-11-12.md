---
created: 2025-11-12 08:29
updated: 2025-11-12 08:29
aliases:
tags:
  - "#daily-note"
log-sleep-hours:
...
const today = dt.fromISO("2025-11-12");
...
```dataviewjs
const today = new Date("2025-11-12"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-11-12").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: 1道算法题) (blockLinkId::  ^s73r) (duration:: 25m) (begin:: 2025-11-12T09:08) - (end:: 2025-11-12T09:33)
☕️ (pomodoro:: BREAK) (duration:: 5m) (begin:: 2025-11-12T09:35) - (end:: 2025-11-12T09:40)
🍅 (pomodoro:: WORK) (taskName:: 1道算法题) (blockLinkId::  ^s73r) (duration:: 25m) (begin:: 2025-11-12T09:55) - (end:: 2025-11-12T10:20)
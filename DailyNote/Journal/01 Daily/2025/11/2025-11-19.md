...
const today = dt.fromISO("2025-11-19");
...
```dataviewjs
const today = new Date("2025-11-19"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-11-19").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: ) (blockLinkId:: ) (duration:: 25m) (begin:: 2025-11-19T09:53) - (end:: 2025-11-19T10:18)
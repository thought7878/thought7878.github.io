---
created: 2025-11-21 08:41
updated: 2025-11-21 08:41
aliases:
tags:
  - "#daily-note"
log-sleep-hours:
...
const today = dt.fromISO("2025-11-21");
...
```dataviewjs
const today = new Date("2025-11-21"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-11-21").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: 1道算法题) (blockLinkId::  ^s73r) (duration:: 25m) (begin:: 2025-11-21T15:02) - (end:: 2025-11-21T15:40)
🍅 (pomodoro:: WORK) (taskName:: 1道算法题) (blockLinkId::  ^s73r) (duration:: 25m) (begin:: 2025-11-21T15:54) - (end:: 2025-11-21T16:19)
🍅 (pomodoro:: WORK) (taskName:: 1道算法题) (blockLinkId::  ^s73r) (duration:: 25m) (begin:: 2025-11-21T16:51) - (end:: 2025-11-21T17:16)
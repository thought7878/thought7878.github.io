---
created: 2025-11-10 08:13
updated: 2025-11-10 08:13
aliases:
tags:
  - "#daily-note"
log-sleep-hours:
...
const today = dt.fromISO("2025-11-10");
...
```dataviewjs
const today = new Date("2025-11-10"); // 从 Templater 获取当前日期
...
from ""
where file.ctime != null and typeof file.ctime == "object" and dateformat(file.ctime, "yyyy-MM-dd") = date("2025-11-10").toISODate()
```
...
🍅 (pomodoro:: WORK) (taskName:: 1道算法题) (blockLinkId::  ^s73r) (duration:: 25m) (begin:: 2025-11-10T08:13) - (end:: 2025-11-10T08:38)
🍅 (pomodoro:: WORK) (taskName:: 1道算法题) (blockLinkId::  ^s73r) (duration:: 25m) (begin:: 2025-11-10T09:01) - (end:: 2025-11-10T09:26)
🍅 (pomodoro:: WORK) (taskName:: 1道算法题) (blockLinkId::  ^s73r) (duration:: 25m) (begin:: 2025-11-10T09:53) - (end:: 2025-11-10T14:23)
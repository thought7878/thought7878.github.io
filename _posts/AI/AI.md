...
AI时代普通人怎么赚钱？硅谷创业者讲了真话 # AI # 人工智能 # 一人公司 # AI工具 # 搞钱 # 赚钱 # AI赚钱 # AI创业 # 硅谷 https://v.douyin.com/_h4dRFqPLvk/
0.71 :7pm a@N.jp xsR:/ 07/02 Obsidian+AI工作台，如何0代码3步实现？ 你每天打开 Obsidian 看到的是什么？空白页面？一堆文件夹？我用 AI 给自己造了一个操控台首页——待办状态、本周任务、频道数据、一键触发工作流，全在一个页面。整个过程不到一小时，零代码。视频里我把方法拆成三步：想清楚需求、找到参考风格、让 AI 实现。从最小的改动开始，你也能做到。 # obsidian # notion# 知识库 # 飞书 # codex https://v.douyin.com/ZlsNtmiJ2go/ 复制此链接，打开Dou音搜索，直接观看视频！

AI速成短视频 验证AI自动化生成商用视频可行性，以苹果笔记本展台摆放角度为切入点，深挖背后营销逻辑，全程依靠 AI 拆分脚本、匹配画面、生成语音，流程简单高效，新手也能快速上手创作。 https://v.douyin.com/idFFAmD4aVE/ 

自媒体神器：Codex 大多数自媒体对技术不是很懂，所以用Codex就好了。从资料搜集、提取、整理，再到内容生成，Codex都给你安排得明明白白。少一点折腾，多一点产出，抓紧起飞！ https://v.douyin.com/RfElTKwTB0o/
...
[人被否定！未来向谁征税？谁来给百姓发钱？](https://v.douyin.com/eRxA4ou1b6U/)

---
转行AI经验分享 | 普通人面试速通攻略 https://v.douyin.com/g7Epo1dbPsE/
 
[码农转全栈的趋势--AI全栈认知](https://v.douyin.com/udFKqojOF_E/)
...
## 费用
[AI模型收费类型眼花缭乱？ 一张图帮你讲清楚！](https://v.douyin.com/7-K3HrukMGs/)
...
[7分钟速通Agent Skills是什么？ 跟MCP|Workflow|Command|Prompt有什么关系？](https://v.douyin.com/hfL_XqUfujg/)
[一个视频彻底搞懂AI大模型Token是什么？词元是什么](https://v.douyin.com/gIE-yORW9j4/)

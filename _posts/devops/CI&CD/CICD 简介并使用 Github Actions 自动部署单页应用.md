...
但前边的部署流程都是<u>基于手动部署</u>，那我们如何将部署进行<u>自动化</u>？**即每当我们将前端代码更新并 PUSH 到仓库后，CICD 将会拉取仓库代码，自动构建并自动部署到服务器。**
...
由于近些年来 CICD 的全面介入，<u>项目开发的工作流就是 CICD 的工作流</u>，请看一个比较完善的 CICD Workflow。

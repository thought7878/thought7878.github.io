**部署**是指将代码发布到服务器的一种行为。**自动化部署**就是使用工具来帮助你实现部署的过程，无需亲自动手。
...
<u>偶尔一次两次还行，如果每次部署项目都这样，就会把很多时间浪费在重复的操作上</u>。所以我们要学会自动部署，彻底解放双手。
...
### [#](https://woai3c.github.io/introduction-to-front-end-engineering/06.html#%E7%9B%91%E5%90%AC-webhook-%E4%BA%8B%E4%BB%B6)监听 `webhook` 事件
...
为了满足不同用户的需要，本章将使用 [Jenkins (opens new window)](https://www.jenkins.io/zh/)和 [Github Actions (opens new window)](https://docs.github.com/en/free-pro-team@latest/actions)来讲解如何部署前端项目。

1. 第一部分讲解如何使用 [Gitea (opens new window)](https://gitea.io/zh-cn/)配置局域网 git 服务器，再使用 Jenkins 将 Gitea 下的项目部署到局域网服务器。
2. 第二部分讲解如何使用 Github Actions 将 Github 项目部署到 [Github Page (opens new window)](https://docs.github.com/cn/free-pro-team@latest/github/working-with-github-pages/about-github-pages)和阿里云服务器。
...
## [#](https://woai3c.github.io/introduction-to-front-end-engineering/06.html#gitea-jenkins-%E8%87%AA%E5%8A%A8%E6%9E%84%E5%BB%BA%E5%89%8D%E7%AB%AF%E9%A1%B9%E7%9B%AE%E5%B9%B6%E9%83%A8%E7%BD%B2%E5%88%B0%E6%9C%8D%E5%8A%A1%E5%99%A8)Gitea + Jenkins 自动构建前端项目并部署到服务器

Gitea 用于构建 Git 局域网服务器，Jenkins 是 CI/CD 工具，用于部署前端项目。

### [#](https://woai3c.github.io/introduction-to-front-end-engineering/06.html#%E9%85%8D%E7%BD%AE-gitea)配置 Gitea

1. 下载 [Gitea (opens new window)](https://dl.gitea.io/gitea)，选择一个喜欢的版本，例如 1.13，选择 `gitea-1.13-windows-4.0-amd64.exe` 下载。
...
### [#](https://woai3c.github.io/introduction-to-front-end-engineering/06.html#%E9%85%8D%E7%BD%AE-jenkins)配置 Jenkins

1. 需要提前安装 JDK，JDK 安装教程网上很多，请自行搜索。

2. 打开 [Jenkins (opens new window)](https://www.jenkins.io/zh/download/)下载页面。 ![在这里插入图片描述](https://img-blog.csdnimg.cn/img_convert/589872cde9a22a23e5a5361e70421d22.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/img_convert/04179bdd1eb246a688608d77cb804330.png) 6. 安装插件，选择第一个。
...
### [#](https://woai3c.github.io/introduction-to-front-end-engineering/06.html#%E5%88%9B%E5%BB%BA%E9%9D%99%E6%80%81%E6%9C%8D%E5%8A%A1%E5%99%A8)创建静态服务器
...
### [#](https://woai3c.github.io/introduction-to-front-end-engineering/06.html#%E8%87%AA%E5%8A%A8%E6%9E%84%E5%BB%BA-%E9%83%A8%E7%BD%B2%E5%88%B0%E6%9C%8D%E5%8A%A1%E5%99%A8)自动构建 + 部署到服务器

1. 下载 Jenkins 提供的 demo 项目 [building-a-multibranch-pipeline-project (opens new window)](https://github.com/jenkins-docs/building-a-multibranch-pipeline-project)，然后在你的 Gitea 新建一个仓库，把内容克隆进去，并提交到 Gitea 服务器。
...
7. 输入 `npm i && npm run build && xcopy .\build\* G:\node-server\dist\ /s/e/y`，这行命令的作用是安装依赖，构建项目，并将构建后的静态资源复制到指定目录 `G:\node-server\dist\`。这个目录是静态服务器资源目录。 ![在这里插入图片描述](https://img-blog.csdnimg.cn/img_convert/bcab4399bd7dc47f075335d1d36ddeb9.png)
...
### [#](https://woai3c.github.io/introduction-to-front-end-engineering/06.html#%E4%BD%BF%E7%94%A8-pipeline-%E6%9E%84%E5%BB%BA%E9%A1%B9%E7%9B%AE)使用 pipeline 构建项目
...
13. 每当你的 Gitea 项目执行 `push` 操作时，Gitea 都会通过 `webhook` 发送一个 post 请求给 Jenkins，让它执行构建及部署操作。 ![在这里插入图片描述](https://img-blog.csdnimg.cn/img_convert/f1a96522b2b7580a880dfd596c16baf7.png)

### [#](https://woai3c.github.io/introduction-to-front-end-engineering/06.html#%E5%B0%8F%E7%BB%93)小结
...
## [#](https://woai3c.github.io/introduction-to-front-end-engineering/06.html#github-actions-%E8%87%AA%E5%8A%A8%E6%9E%84%E5%BB%BA%E5%89%8D%E7%AB%AF%E9%A1%B9%E7%9B%AE%E5%B9%B6%E9%83%A8%E7%BD%B2%E5%88%B0%E6%9C%8D%E5%8A%A1%E5%99%A8)Github Actions 自动构建前端项目并部署到服务器

如果你的项目是 Github 项目，那么使用 Github Actions 也许是更好的选择。

### [#](https://woai3c.github.io/introduction-to-front-end-engineering/06.html#%E9%83%A8%E7%BD%B2%E5%88%B0-github-page)部署到 Github Page
...
具体详情可以参考一下我的 demo 项目 **[github-actions-demo (opens new window)](https://github.com/woai3c/github-actions-demo)**。

构建成功后，打开 Github Page 网站，可以发现内容已经发布成功。

![在这里插入图片描述](https://img-blog.csdnimg.cn/img_convert/ff5f3280dbe6bde247af8d34231b2eda.png)

### [#](https://woai3c.github.io/introduction-to-front-end-engineering/06.html#github-actions-%E9%83%A8%E7%BD%B2%E5%88%B0%E9%98%BF%E9%87%8C%E4%BA%91)Github Actions 部署到阿里云

#### [#](https://woai3c.github.io/introduction-to-front-end-engineering/06.html#%E5%88%9D%E5%A7%8B%E5%8C%96%E9%98%BF%E9%87%8C%E4%BA%91%E6%9C%8D%E5%8A%A1%E5%99%A8)初始化阿里云服务器
...
#### [#](https://woai3c.github.io/introduction-to-front-end-engineering/06.html#%E5%88%9B%E5%BB%BA%E4%B8%80%E4%B8%AA%E9%9D%99%E6%80%81%E6%9C%8D%E5%8A%A1%E5%99%A8)创建一个静态服务器
...
注意，监听 IP 必须为 `0.0.0.0` ，详情请看[部署Node.js项目注意事项 (opens new window)](https://www.alibabacloud.com/help/zh/doc-detail/50775.htm)。

阿里云入端口要在网络安全组中查看与配置。

![在这里插入图片描述](https://img-blog.csdnimg.cn/img_convert/0814d06c8887e7e2b110388619b480ba.png)

#### [#](https://woai3c.github.io/introduction-to-front-end-engineering/06.html#%E5%88%9B%E5%BB%BA%E9%98%BF%E9%87%8C%E4%BA%91%E5%AF%86%E9%92%A5%E5%AF%B9)创建阿里云密钥对

请参考[创建SSH密钥对 (opens new window)](https://www.alibabacloud.com/help/zh/doc-detail/51793.htm)和[绑定SSH密钥对 (opens new window)](https://www.alibabacloud.com/help/zh/doc-detail/51796.htm?spm=a2c63.p38356.879954.9.cf992580IYf2O7#concept-zzt-nl1-ydb)，将你的 ECS 服务器实例和密钥绑定，然后将私钥保存到你的电脑（例如保存在 ecs.pem 文件）。
...
如果还是不懂，建议看一下我的 [demo (opens new window)](https://github.com/woai3c/github-actions-aliyun-demo)。

### [#](https://woai3c.github.io/introduction-to-front-end-engineering/06.html#ci-yml-%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6%E8%AE%B2%E8%A7%A3)`ci.yml` 配置文件讲解
...
4. `runs-on`，表示你这个工作流程要运行在什么操作系统上，`ci.yml` 文件定义的是最新稳定版的 `ubuntu`。除了 ubuntu，它还可以选择 Mac 或 Windows。 ![](https://img-blog.csdnimg.cn/img_convert/9e3d168e93618dbd641f27d325aa00be.png)

5. `steps`，看字面意思就是一系列的步骤，也就是说这个作业由一系列的步骤完成。例如先执行 `step1`，再执行 `step2`...

#### [#](https://woai3c.github.io/introduction-to-front-end-engineering/06.html#setps-%E6%AD%A5%E9%AA%A4%E8%AE%B2%E8%A7%A3)`setps` 步骤讲解
...
## [#](https://woai3c.github.io/introduction-to-front-end-engineering/06.html#%E9%83%A8%E7%BD%B2%E6%96%B9%E5%BC%8F)部署方式
...
### [#](https://woai3c.github.io/introduction-to-front-end-engineering/06.html#%E8%93%9D%E7%BB%BF%E9%83%A8%E7%BD%B2)蓝绿部署
...
### [#](https://woai3c.github.io/introduction-to-front-end-engineering/06.html#%E6%BB%9A%E5%8A%A8%E5%8F%91%E5%B8%83)滚动发布
...
### [#](https://woai3c.github.io/introduction-to-front-end-engineering/06.html#%E7%81%B0%E5%BA%A6%E5%8F%91%E5%B8%83)灰度发布
...
## [#](https://woai3c.github.io/introduction-to-front-end-engineering/06.html#%E5%B0%8F%E7%BB%93-2)小结
...
- [带你入门前端工程](https://woai3c.github.io/introduction-to-front-end-engineering/06.html#gitea-jenkins-%E8%87%AA%E5%8A%A8%E6%9E%84%E5%BB%BA%E5%89%8D%E7%AB%AF%E9%A1%B9%E7%9B%AE%E5%B9%B6%E9%83%A8%E7%BD%B2%E5%88%B0%E6%9C%8D%E5%8A%A1%E5%99%A8)
- [Jenkins 用户手册(opens new window)](https://www.jenkins.io/zh/doc/)
- [GitHub Actions 文档(opens new window)](https://docs.github.com/cn/free-pro-team@latest/actions)
- [GitHub Pages 文档(opens new window)](https://docs.github.com/cn/free-pro-team@latest/github/working-with-github-pages/about-github-pages)
- [Gitea 文档(opens new window)](https://docs.gitea.io/zh-cn/)
- [GitHub 操作的工作流程语法(opens new window)](https://docs.github.com/cn/free-pro-team@latest/actions/reference/workflow-syntax-for-github-actions)

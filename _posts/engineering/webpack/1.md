...
在这个数量级下，源码的阅读、分析、学习成本非常高，加上 webpack 官网语焉不详的文档，导致 webpack 的学习、上手成本极其高。为此，社区围绕着 Webpack 衍生出了各种手脚架，比如 [vue-cli](https://link.juejin.cn?target=https%3A%2F%2Fcli.vuejs.org%2Fguide%2F "https://cli.vuejs.org/guide/")、[create-react-app](https://link.juejin.cn?target=https%3A%2F%2Freactjs.org%2Fdocs%2Fcreate-a-new-react-app.html "https://reactjs.org/docs/create-a-new-react-app.html")，解决“用”的问题。
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ba579d352683432094302852a3037963~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.awebp)
...
也就是将各种类型的资源，包括图片、css、js等，转译、组合、拼接、生成 JS 格式的 bundler 文件。[官网首页](https://link.juejin.cn?target=https%3A%2F%2Fwebpack.js.org%2F "https://webpack.js.org/")的动画很形象地表达了这一点：

![1d66a833-2841-4a8a-a91a-0da800fab306.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d1d3e3165499409e925c2832e0566df4~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.awebp)
...
webpack 编译过程都是围绕着这些关键对象展开的，更详细完整的信息，可以参考 [Webpack 知识图谱](https://juejin.cn/post/6948763207397965855 "https://juejin.cn/post/6948763207397965855") 。
...
2. 调用 [loader-runner](https://link.juejin.cn?target=https%3A%2F%2Fwww.npmjs.com%2Fpackage%2Floader-runner "https://www.npmjs.com/package/loader-runner") 仓库的 `runLoaders` 转译 `module` 内容，通常是从各类资源类型转译为 JavaScript 文本
3. 调用 [acorn](https://link.juejin.cn?target=https%3A%2F%2Fwww.npmjs.com%2Fpackage%2Facorn "https://www.npmjs.com/package/acorn") 将 JS 文本解析为AST
4. 遍历 AST，触发各种钩子
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/16ff09e71aec484eb394696ccb9d60a0~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.awebp)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d9c9ca778cf545de9099c463723d8f1b~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.awebp)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0a43a123b172418aba4019dbd79e064d~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.awebp)

从 a.js 模块中又解析到 c.js/d.js 依赖，于是再再继续调用 `module[a.js]` 的 `handleParseResult` ，再再递归上述流程：

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0c22cb909cbd46cf98bbc64fdec5065f~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.awebp)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ae16969ecfe44bb8aef5f628fdd60f9b~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.awebp)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/857866c0c60f44cfb8a87e67723c017b~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.awebp)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/9b4d576b67404c28b01b6390f60d4e3f~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.awebp)
...
![image (3).png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/57de01d125a349f1ba58e56024063f85~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.awebp)
...
钩子的核心逻辑定义在 [Tapable](https://link.juejin.cn?target=https%3A%2F%2Fgithub.com%2Fwebpack%2Ftapable "https://github.com/webpack/tapable") 仓库，内部定义了如下类型的钩子：
...
![image.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/45520a6a81684fb99664f8d7a7089e6e~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.awebp)

而 `compilation` 对象逐次触发：

![image (1).png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/de1f0d05a1274e6d86959b60a3d98742~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.awebp)
...
- [compilation.addModule](https://link.juejin.cn?target=https%3A%2F%2Fwebpack.js.org%2Fapi%2Fcompilation-object%2F%23addmodule "https://webpack.js.org/api/compilation-object/#addmodule") ：添加模块，可以在原有的 module 构建规则之外，添加自定义模块
- [compilation.emitAsset](https://link.juejin.cn?target=https%3A%2F%2Fwebpack.js.org%2Fapi%2Fcompilation-object%2F%23emitasset "https://webpack.js.org/api/compilation-object/#emitasset")：直译是“提交资产”，功能可以理解将内容写入到特定路径
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/1c11e6fc73724a2f9197676c538c8173~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.awebp)
...
为了帮助理解，这里补充一个示例： [Webpack 案例 -- vue-loader 原理分析](https://juejin.cn/post/6937125495439900685 "https://juejin.cn/post/6937125495439900685")。
...
![module 体系.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/69b15fda723b4dacab9cd9ae9f51312a~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.awebp)

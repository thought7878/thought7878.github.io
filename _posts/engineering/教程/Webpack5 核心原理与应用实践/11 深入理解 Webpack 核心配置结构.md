Webpack 是*一种 **「配置」** 驱动的构建工具*，所以站在应用的角度，必须深入学习 Webpack 的各项配置规则，才能灵活应对各种构建需求。本文将作为小册应用系列的一个总结，汇总与应用配置相关的各项知识点，包括：
...
![[engineering/教程/Webpack5 核心原理与应用实践/media/7ece0eae0fe99d3fd76db78e38afbd5e_MD5.webp]]
...
![[engineering/教程/Webpack5 核心原理与应用实践/media/96d99a165eb704a06364d96246b59324_MD5.webp]]

左边为 `main` 产物，包含所有模块、运行时代码，与普通 Bundle 无异；右边为 `foo` 产物，代码结构非常清爽。作为对比，若不指定 `dependOn` 属性，则构建结果：

![[engineering/教程/Webpack5 核心原理与应用实践/media/7428c8157fccc1d0d31d6f082c70cde1_MD5.webp]]
...
![[engineering/教程/Webpack5 核心原理与应用实践/media/2a2fc45cd340c84e003cbdde97221cf7_MD5.webp]]
...
![[engineering/教程/Webpack5 核心原理与应用实践/media/c24cf878997dbf6338bb004f99b407d5_MD5.webp]]

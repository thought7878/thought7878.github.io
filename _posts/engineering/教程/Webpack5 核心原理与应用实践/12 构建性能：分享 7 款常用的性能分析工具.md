...
**Webpack 最核心的功能**，*一是使用适当 Loader 将任意类型文件/模块转译为 JavaScript 代码*，例如将 CSS 代码转译为 JS 字符串，将多媒体文件转译为 Base64 代码等；*二是将这些经过 Loader 处理的文件资源合并、打包成向下兼容的产物文件*。
...
![[engineering/教程/Webpack5 核心原理与应用实践/media/cd5ef36951e639d6698109f5dcb3a524_MD5.webp]]

点击页面中的 `modules/chunks/assets` 按钮，页面会渲染出对应实体的依赖关系图，例如：

![[engineering/教程/Webpack5 核心原理与应用实践/media/022da909f07df78a475ed99f51b5e6a5_MD5.webp]]

除 `modules/chunks/assets` 外，右上方菜单栏 **Hints** 还可以查看构建过程各阶段、各模块的处理耗时，可以用于对比分析各个阶段的性能情况：

![[engineering/教程/Webpack5 核心原理与应用实践/media/e3638d9003fcc20a3d8b51344ae460db_MD5.webp]]
...
![[engineering/教程/Webpack5 核心原理与应用实践/media/e6e3b6bcb5a70e41f444e51adf91fe3e_MD5.webp]]
...
![[engineering/教程/Webpack5 核心原理与应用实践/media/7e80c1602f6ba3e27c6338764982731b_MD5.webp]]
...
![[engineering/教程/Webpack5 核心原理与应用实践/media/fbd8211b4d19c630982f7bcdcdf95651_MD5.webp]]
...
![[engineering/教程/Webpack5 核心原理与应用实践/media/9ad539fc06130f7b2ff001ad9d8d0792_MD5.webp]]
...
![[engineering/教程/Webpack5 核心原理与应用实践/media/466a2a92d9f1f3d14e2ba2da3cbd9348_MD5.webp]]
...
![[engineering/教程/Webpack5 核心原理与应用实践/media/72c9d37e07241ff01b82ce3c0e2c3e47_MD5.webp]]
...
![[engineering/教程/Webpack5 核心原理与应用实践/media/e6fe11334e47ef8d4705e8be8cc50937_MD5.webp]]

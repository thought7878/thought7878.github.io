...
![[engineering/教程/Webpack5 核心原理与应用实践/media/de248f8efa484b35ac421b770e3bbb61_MD5.webp]]
...
![[engineering/教程/Webpack5 核心原理与应用实践/media/42d51688bbb921c995d6c3e8014f70c0_MD5.webp]]

- 使用 `this.emitError` 接口，同样不会打断编译流程，效果：

![[engineering/教程/Webpack5 核心原理与应用实践/media/26284c75ad8d85fadcaa334def839319_MD5.webp]]
...
![[engineering/教程/Webpack5 核心原理与应用实践/media/fb96c484c4a97825cbee7e2473931edb_MD5.webp]]
...
![[engineering/教程/Webpack5 核心原理与应用实践/media/86f030e05b14d3e8c094ae37e7d2d86b_MD5.webp]]
...
![[engineering/教程/Webpack5 核心原理与应用实践/media/5f17621cb44732a38685f43195c7e357_MD5.webp]]

`pitch` 阶段按配置顺序从左到右逐个执行 `loader.pitch` 函数(如果有的话)，开发者可以在 `pitch` 返回任意值中断后续的链路的执行：

![[engineering/教程/Webpack5 核心原理与应用实践/media/5f0f9355567a911cc7c35bb643f469d0_MD5.webp]]
...
![[engineering/教程/Webpack5 核心原理与应用实践/media/a1fac3380874a7d78b93cadac521c80e_MD5.webp]]

...
![[engineering/教程/Webpack5 核心原理与应用实践/media/0a0bd61962bd165d4967413b5d53997e_MD5.webp]]
...
![[engineering/教程/Webpack5 核心原理与应用实践/media/b57ac53ab68618fdadac6efcd90e2d13_MD5.webp]]
...
![[engineering/教程/Webpack5 核心原理与应用实践/media/5d7c739a1da70b4458dc3b1e5b28fe31_MD5.webp]]
...
| -------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![[engineering/教程/Webpack5 核心原理与应用实践/media/454b2a57f0acf5c24a0f75d942d2f3fc_MD5.webp]] | /* ... */<br>.sprite(@sprite) {<br>  .sprite-image(@sprite);<br>  .sprite-position(@sprite);<br>  .sprite-width(@sprite);<br>  .sprite-height(@sprite);<br>}<br>/* ... */ |
...
![[engineering/教程/Webpack5 核心原理与应用实践/media/95ce4d5534e1612206d0aa6e52e2ac68_MD5.webp]]

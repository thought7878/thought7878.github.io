...
## 介绍 Webpack **文件分类**管理方法

[04:23]
目前所有文件（javascript、css、图片等）**都生成在单一磁盘文件夹**，可通过配置**让 webpack 将不同类型文件放入独立子文件夹**，如在 list 文件夹内创建 js 文件夹存放 javascript 文件，创建对应文件夹存放 css 文件。

![[_posts/engineering/1.打包工具（Module Bundler）/webpack/教程/Webpack 5 Optimizing For Production/03. 7 Ways Of Using CSS With Webpack/media/c57252785897c81b19a40d5069d9abb9_MD5.jpeg]]

![[_posts/engineering/1.打包工具（Module Bundler）/webpack/教程/Webpack 5 Optimizing For Production/03. 7 Ways Of Using CSS With Webpack/media/e4e7775107c83ad2878f818e314662d5_MD5.jpeg]]

...
其中`“chunks”属性`**指示待优化的代码块**，值为“all”时*定义的规则适用于所有代码块，对所有类型的 chunk 都进行分割*，还可设为“initial”（*仅应用于启动时加载的代码块*）和“async”（*应用加载后异步加载的代码块，如动态导入的代码*）；
...
[09:35]
为生产环境构建应用后，打开浏览器并查看网络标签，**初始加载时浏览器下载 5 份 JS 文件（共约 340 千字节），无 Bootstrap 相关文件**；
添加新待办事项时网络标签无变化，**点击删除待办事项时，浏览器才发送请求下载包含 Bootstrap 的 JS 文件（约 80.6 千字节）**。
**总下载量变为 420 千字节，证明初始加载减少 80 千字节下载量，实现性能提升。**

![[_posts/engineering/1.打包工具（Module Bundler）/webpack/教程/Webpack 5 Optimizing For Production/08. Applying Code Splitting and Lazy Loading/media/8e54065f7c4c26b935025a715bdf2ad4_MD5.jpeg]]

![[_posts/engineering/1.打包工具（Module Bundler）/webpack/教程/Webpack 5 Optimizing For Production/08. Applying Code Splitting and Lazy Loading/media/f38e848ab5a575bbf3348577d5978261_MD5.jpeg]]
...
那么除了热更新以外，项目的开发环境还有哪些在影响着我们的开发效率呢？在过去的工作中，公司同事就曾问过我一个问题：<u>为什么我的项目在开发环境下每次构建还是很卡？每次保存完代码都要过 1~2 秒才能看到效果，这是怎么回事呢？</u>其实这里面的原因主要是这位同事在开发时选择的 Source Map 设定不对。今天我们就来具体讨论下这个问题。首先，什么是 **Source Map** 呢？

### 什么是 Source Map

在前端开发过程中，<u>通常我们编写的源代码会经过多重处理（编译、封装、压缩等），最后形成产物代码。于是在浏览器中调试产物代码时，我们往往会发现代码变得面目全非</u>，例如：

![[_posts/engineering/_教程/前端工程化精讲/1.开发效率/media/b7f9a9c04f0fdc8856b8e72d173b5ed3_MD5.png]]

因此，我们需要一种在调试时将产物代码显示回源代码的功能，**source map** 就是实现这一目标的工具。

**source-map 的基本原理**是，在编译处理的过程中，在生成产物代码的同时生成产物代码中被转换的部分与源代码中相应部分的映射关系表。有了这样一张完整的映射表，我们就可以通过 Chrome 控制台中的”Enable Javascript source map”来实现调试时的显示与定位源代码功能。
...
![[_posts/engineering/_教程/前端工程化精讲/1.开发效率/media/3d578f9c86b057d4df90e0ee388a1963_MD5.png]]
...
![[_posts/engineering/_教程/前端工程化精讲/1.开发效率/media/4bfaa3ddd9f40c3ce96a202a1744f184_MD5.png]]

- 源码不包含列信息

![[_posts/engineering/_教程/前端工程化精讲/1.开发效率/media/3a598f612e14c7adc91cd5592762ce2a_MD5.png]]

- Loader转换后代码

![[_posts/engineering/_教程/前端工程化精讲/1.开发效率/media/3ecf5c2106c8dddb31b6756de08175d4_MD5.png]]

- 生成后的产物代码

![[_posts/engineering/_教程/前端工程化精讲/1.开发效率/media/10628999d1f9da9c1eef453d7bff776c_MD5.png]]
...
![[_posts/engineering/_教程/前端工程化精讲/1.开发效率/media/654719a41f85489548de3a9962a748bf_MD5.png]]

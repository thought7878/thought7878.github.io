...
下面，言归正传，我们**通过流程图来分析 npm install 的安装流程/机制：**

![[_posts/engineering/_教程/前端基础建设与架构 30 讲/01.前端工程化管理工具篇/media/cd0d61f8f88c65c49f96668d014d4f73_MD5.png]]

					npm install 安装流程图

npm install 执行之后：

**首先，检查并获取 npm 配置**，这里的*优先级为：项目级的 .npmrc 文件 > 用户级的 .npmrc 文件> 全局级的 .npmrc 文件 > npm 内置的 .npmrc 文件*。
...
构建依赖树时，当前依赖项目不管其是直接依赖还是子依赖的依赖，**都应该按照扁平化原则，优先将其放置在 node\_modules 根目录**（最新版本 npm 规范）：
- 在这个过程中，遇到相同模块就判断已放置在依赖树中的模块版本是否符合新模块的版本范围，如果符合则跳过；
- 不符合则在当前模块的 node\_modules 下放置该模块（最新版本 npm 规范）。
...
![[_posts/engineering/_教程/前端基础建设与架构 30 讲/01.前端工程化管理工具篇/media/210c972921cee7c64cc1acd24e60f6fb_MD5.png]]
...
![[_posts/engineering/_教程/前端基础建设与架构 30 讲/01.前端工程化管理工具篇/media/1aec6468945942949c17277c3b56a368_MD5.png]]
...
![[_posts/engineering/_教程/前端基础建设与架构 30 讲/01.前端工程化管理工具篇/media/4ca5d3870046ae16897f40e769e2bc3a_MD5.png]]
...
![[_posts/engineering/_教程/前端基础建设与架构 30 讲/01.前端工程化管理工具篇/media/5e7d2ac6172bf7b5fdd38dc873fa6dd7_MD5.png]]
...
[![[_posts/engineering/_教程/前端基础建设与架构 30 讲/01.前端工程化管理工具篇/media/01967427478823641a2ea18f895df61c_MD5.png]]](https://shenceyun.lagou.com/t/mka)

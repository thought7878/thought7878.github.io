...
### 暂存 未提交更改
它允许你**暂时保存**当前工作目录（包括暂存区）的修改，让工作区恢复到干净的状态（即最后一次提交的状态）。这样你可以切换到其他分支、拉取更新或修复紧急 bug，之后再恢复这些修改。
...
## 独自使用Git时的常见场景
参考：[[2.独自使用Git时的常见场景 (16讲)]]
## Git与GitHub的简单同步

## 多人协作时的常见场景

### 35 | 不同人修改了**同文件的不同区域**如何处理？

### 36 | 不同人修改了**同文件的同一区域**如何处理？

### 37 | *同时变更了文件名和文件内容*如何处理？

### 38 | *把同一文件改成了不同的文件名*如何处理？
### 禁止向集成分支执行push -f操作
### 禁止向集成分支执行变更历史的操作

## 使用GitHub进行团队协作
[[7.使用GitHub进行团队协作 (10讲)]]
### 怎样选择适合自己团队的工作流？
### 如何挑选合适的分支集成策略？
### 项目内部怎么实施code review？

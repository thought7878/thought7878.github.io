...
![[_posts/typescript/教程/TypeScript 类型体操通关秘籍/media/9a27a752563900bf47207114b9781533_MD5.png]]
...
除了描述类型的结构外，TypeScript 的类型系统还支持*描述类型的属性*，比如是否可选，是否只读等：
...
![[_posts/typescript/教程/TypeScript 类型体操通关秘籍/media/ffa74847ce70d6f9063b464c98791488_MD5.png]]

这就是 TypeScript 类型系统里的 if else。

但是，上面这样的逻辑没啥意义，静态的值自己就能算出结果来，为什么要用代码去判断呢？

所以，**类型运算**逻辑都是用来做一些**动态的类型的运算**的，也就是**对类型参数的运算**。
...
![[_posts/typescript/教程/TypeScript 类型体操通关秘籍/media/6b1f7ad4780fa6f2f6367616c0eb201e_MD5.png]]

![[_posts/typescript/教程/TypeScript 类型体操通关秘籍/media/d72fb43c24c1032f7fd29f99831abdc6_MD5.png]]
...
```
![[_posts/typescript/教程/TypeScript 类型体操通关秘籍/media/82df396bfde646c09be5806f87d3066d_MD5.png]]
...
![[_posts/typescript/教程/TypeScript 类型体操通关秘籍/media/04f2389ada9541c51cfaad070fd6edb1_MD5.png]]

注意，同一类型可以合并，不同的类型没法合并，会被舍弃：

![[_posts/typescript/教程/TypeScript 类型体操通关秘籍/media/2c3c08a8a1bf6499d4b6a106eb20616a_MD5.png]]
...
![[_posts/typescript/教程/TypeScript 类型体操通关秘籍/media/eac6e16e56526df7487639683bc418fd_MD5.png]]
...
![[_posts/typescript/教程/TypeScript 类型体操通关秘籍/media/d0b31582546f95f34bbc6bafb8cf80e1_MD5.png]]
...
![[_posts/typescript/教程/TypeScript 类型体操通关秘籍/media/185e18eb4b7e97e6b4a4b515de64ef3b_MD5.png]]
...
![[_posts/typescript/教程/TypeScript 类型体操通关秘籍/media/0d36a7e83d8852d6441d7ef59c0c630d_MD5.png]]

...
Vue 框架是热门的渐进式 JavaScript 框架。在 Vue 中，当我们修改状态时，视图会随之更新，这背后依赖就是Vue的响应式系统。   
**响应式系统**是Vue 最独特的特性之一。如果读者没有接触过 Vue，强烈建议阅读[Vue官方对响应式原理的介绍](https://v2.cn.vuejs.org/v2/guide/reactivity.html)。此处我们用官方的一张流程图来简要地说明一下Vue响应式系统的整个流程：   


![[设计模式/JavaScript 设计模式核心原理与应用实践/media/4c91d22ec239f7f841531cb9a076e6d4_MD5.png]]  
...
![[设计模式/JavaScript 设计模式核心原理与应用实践/media/d484cb4d96c641ad30a171a0db920829_MD5.png]]
...
*Event Bus/Event Emitter 作为全局事件总线，它起到的是一个**沟通桥梁**的作用*。**我们可以把它理解为一个*事件中心*，我们所有事件的订阅/发布都不能由订阅方和发布方“私下沟通”，必须要委托这个事件中心帮我们实现**。    
在Vue中，有时候 A 组件和 B 组件中间隔了很远，看似没什么关系，但我们希望它们之间能够通信。这种情况下除了求助于 Vuex 之外，我们还可以*通过 Event Bus 来实现我们的需求*。  
...
下面，我们就一起来*实现一个Event Bus*（注意看注释里的解析）：    
...
![[设计模式/JavaScript 设计模式核心原理与应用实践/media/a54adc68d74db74c55acad2b3b1b0944_MD5.png|"观察者模式"]]   




![[设计模式/JavaScript 设计模式核心原理与应用实践/media/6a59b20e253f6ec6917ce3f1c1663bd8_MD5.png|"发布-订阅模式"]]

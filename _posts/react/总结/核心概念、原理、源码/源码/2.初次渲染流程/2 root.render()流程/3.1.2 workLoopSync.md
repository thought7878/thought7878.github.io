...
### 函数功能详解：
[workLoopSync](file:///Users/ll/Desktop/%E8%B5%84%E6%96%99/%E7%BC%96%E7%A8%8B/%E4%BB%93%E5%BA%93/react/react-18.2.0/packages/react-reconciler/src/ReactFiberWorkLoop.new.js#L1792-L1799) 函数是 *React 同步渲染循环的核心部分*，它负责协调渲染工作，***遍历整个`组件树/ReactElement树`，并创建/更新每一个对应的 Fiber 节点，并构建Fiber树***。
...
function workLoopSync() {
  ...
  while (workInProgress !== null) {
    // ！！！执行一个工作单元，创建/更新每一个 Fiber 节点，并构建Fiber树（这将处理当前的Fiber节点并将其连接到下一个要处理的节点）

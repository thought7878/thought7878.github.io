...
function prepareFreshStack(root: FiberRoot, lanes: Lanes): Fiber {
  ...
  // ！！！创建一个新的rootFiber（工作进程 Fiber），基于当前的rootFiber（createRoot创建的rootFiber）

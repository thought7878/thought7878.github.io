---
title: React技术揭秘
source: https://react.iamkasong.com/renderer/beforeMutation.html#%E6%A6%82%E8%A7%88
author:
published:
created: 2026-02-24
...
我们*接下来讨论 useEffect 如何被异步调度，以及为什么要异步（而不是同步）调度*。
...
可见， **useEffect 异步执行的原因**主要是**防止同步执行时阻塞浏览器渲染**。

...
参考：[[代数效应（Algebraic Effects）]]

- 概念定义  
    `代数效应（Algebraic Effects）`是*函数式编程*中的一个概念，用于**将副作用从函数调用中分离，本质就是关注点分离**。
- 虚构示例说明
...
![[_posts/react/总结/核心概念、原理、源码/源码/教程/2.自顶向下学 React 源码/1.理念篇/media/de4932d20b3cbe14756bf34fa0edf937_MD5.webp]]
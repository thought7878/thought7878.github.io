---
title: React技术揭秘
source: https://react.iamkasong.com/process/doubleBuffer.html#%E4%BB%80%E4%B9%88%E6%98%AF-%E5%8F%8C%E7%BC%93%E5%AD%98
author:
published:
created: 2026-02-27
...
![[_posts/react/总结/核心概念、原理、源码/源码/教程/2.自顶向下学 React 源码/1.理念篇/media/f18e5c21c191708994b83596f03acefa_MD5.png]]
```js
...
![[_posts/react/总结/核心概念、原理、源码/源码/教程/2.自顶向下学 React 源码/1.理念篇/media/2efd8a6f7b0577c1a3690d8117b6dc13_MD5.png]]
...
![[_posts/react/总结/核心概念、原理、源码/源码/教程/2.自顶向下学 React 源码/1.理念篇/media/ede1ad77215f5ad5736a9fa81ef57dd7_MD5.png]]

## update 时

1. 接下来我们点击 `p节点` 触发状态改变，这会开启一次新的 `render阶段` 并构建一棵新的 `workInProgress Fiber 树` 。
![[_posts/react/总结/核心概念、原理、源码/源码/教程/2.自顶向下学 React 源码/1.理念篇/media/a98beca6ff7ed3e7b342e0128b502253_MD5.png]]
...
![[_posts/react/总结/核心概念、原理、源码/源码/教程/2.自顶向下学 React 源码/1.理念篇/media/f8bd33c6531050fc3a711b7f1d472a97_MD5.png]]

## 总结

本文介绍了 `Fiber树` 的构建与替换过程，这个过程伴随着 `DOM` 的更新。

那么在构建过程中每个 `Fiber节点` 具体是如何创建的呢？我们会在 `架构篇` 的 [render 阶段](https://react.iamkasong.com/process/reconciler.html) 讲解。
...
[关注公众号 魔术师卡颂](https://react.iamkasong.com/me.html) ，后台回复 **812** 获得在线 Demo 地址
...
- **作为静态的数据结构**  
    每个 fiber 节点*对应一个组件，保存组件类型、对应的 DOM 节点等信息*，也被称为虚拟节点。
- **作为动态的工作单元**  
    fiber 节点*保存组件需要更新的状态和副作用*，用于*实现可中断的更新机制*。
...
![[_posts/react/总结/核心概念、原理、源码/源码/教程/2.自顶向下学 React 源码/1.理念篇/media/e0c1483225bfa76c7dd52f81ccdeb077_MD5.webp]]
...
- **current 与 workInProgress 的关系**
    - current 树代表*当前页面内容*。
    - workInProgress 树是*正在构建的新版本*。
    - 所有存在的 fiber 节点*通过 `alternate` 属性互相连接*。
    - ***更新渲染时，diff 算法在此过程中，对比 current fiber 与新 ReactElement（新 JSX 结构），生成 workInProgress fiber***；首次渲染不需对比。

首次渲染：
![[_posts/react/总结/核心概念、原理、源码/源码/教程/2.自顶向下学 React 源码/1.理念篇/media/c93d2451495bfd477930a6be4fad6c3d_MD5.webp]]
更新渲染：
![[_posts/react/总结/核心概念、原理、源码/源码/教程/2.自顶向下学 React 源码/1.理念篇/media/827127d1a20fa03db445223e9fa2a6ca_MD5.webp]]

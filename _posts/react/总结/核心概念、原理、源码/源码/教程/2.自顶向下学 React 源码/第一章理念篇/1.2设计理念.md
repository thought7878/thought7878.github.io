...
![[_posts/react/总结/核心概念、原理、源码/源码/教程/2.自顶向下学 React 源码/第一章理念篇/media/41c69136578c86a65134a4096b8f4706_MD5.webp]]
...
- 浏览器刷新机制  
    浏览器每帧时间为约16.6毫秒，依次用于执行脚本、样式布局与绘制。
- JS执行超时的影响  
...
- React的创新方案  
    引入异步可中断更新机制：
    - 浏览器将每一帧中的一部分时间预留给React。
    - 若当前任务执行时间超出预留时间，React会中断工作，将控制权交还浏览器。

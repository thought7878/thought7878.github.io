...
![[_posts/react/总结/核心概念、原理、源码/源码/教程/2.自顶向下学 React 源码/media/b1faef95428210e8c99e9fb2deca9f6a_MD5.webp]]
...
- Fiber的定义与背景
    - Fiber 是操作系统中“纤程”的一种实现，与进程、线程、协程同属程序执行模型。
    - React中已有类似实现为 Generator。
- 为何不使用Generator？

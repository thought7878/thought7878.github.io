...
你可以*从 [这里](https://zh-hans.reactjs.org/docs/hooks-intro.html#motivation) 了解 Hooks 的设计动机*。作为一名 框架使用者 ，了解 设计动机 对于我们日常开发就足够了。
...
React LOGO 的图案是*代表 原子 （ atom ）的符号*。*世间万物由 原子 组成， 原子 的 类型 与 属性 决定了事物的外观与表现。*

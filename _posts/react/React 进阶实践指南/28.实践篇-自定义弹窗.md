...
**Portal 提供了一种将子节点渲染到存在于父组件以外的 DOM 节点**的优秀的方案。**createPortal 可以把当前组件或 element 元素的子节点，渲染到组件之外的其他地方**。
...
上面既然完成了挂载组件，下面需要*在隐藏 Modal 的时候去卸载组件*。 可以通过 `ReactDOM.unmountComponentAtNode` 来实现这个功能。
**unmountComponentAtNode 从 DOM 中卸载组件，会将其事件处理器和 state 一并清除**。 如果指定容器上没有对应已挂载的组件，这个函数什么也不会做。如果组件被移除将会*返回 true* ，如果没有组件可被移除将会返回 false 。
...
![[react/React 进阶实践指南/media/4c008b7e318df01d0285300b89c67323_MD5.jpg]]

关闭弹窗流程图：


![[react/React 进阶实践指南/media/94a29fe5276176fd0362f34bd5f3ce4c_MD5.jpg]]
...
![[react/React 进阶实践指南/media/b75d6db77272513867c548813c84d0fe_MD5.gif]]
...
![[react/React 进阶实践指南/media/1f7c6aca43f1684baae1c2080a92401f_MD5.gif]]

...
Fiber 的英文的是’纤维‘，fiber 诞生在 `Reactv16` 版本，整个 React 团队花费两年时间重构 fiber 架构，目的就是**解决大型 React 应用卡顿**；fiber 在 React 中是最小粒度的执行单元，无论 React 还是 Vue ，在遍历更新每一个节点的时候都不是用的真实 DOM ，都是采用虚拟 DOM ，所以*可以理解成 fiber 就是 React 的虚拟 DOM* 。
...
![[react/React 进阶实践指南/media/81027dae623a057849d21a16e3f774bd_MD5.jpg]]
...
![[react/React 进阶实践指南/media/88abfb1810b2f5c163514e63f08cb477_MD5.jpg]]
...
* `fiberRoot`：首次构建应用， 创建一个 fiberRoot ，作为*整个 React 应用的根基*。
...
![[react/React 进阶实践指南/media/cbcf397bedee3ee1b3a60119babac543_MD5.jpg]]
...
![[react/React 进阶实践指南/media/916ec941b55333555dc53de2099248c4_MD5.jpg]]
...
![[react/React 进阶实践指南/media/4219ec958fec9b657e97b52f8573b965_MD5.jpg]]
...
![[react/React 进阶实践指南/media/38d6921d367a0e631f9caeb17656eb2b_MD5.jpg]]


### 2 更新
如果对于上述 demo ，开发者点击一次按钮发生更新，接下来会发生什么呢?
*首先会走如上的逻辑，重新创建一颗 workInProgress 树，复用当前 current 树上的 alternate ，作为新的 workInProgress ，由于初始化 rootFiber 有 alternate ，所以对于剩余的子节点，React 还需要创建一份，和 current 树上的 fiber 建立起 alternate 关联。渲染完毕后，workInProgress 再次变成 current 树。*

效果：


![[react/React 进阶实践指南/media/523f9a4952e38156d5c072ac7fd518cd_MD5.jpg]]

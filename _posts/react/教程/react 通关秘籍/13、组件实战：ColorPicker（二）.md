...
![[c6b1df9f077e93ddf1eadb1e61bf62a4_MD5.png]]

可以分成这三部分：

![[b5b2121809f2c83c12858545006a986f_MD5.png]]
...
![[6c71cdbfcb8bcf266c1b3ff1fcba637a_MD5.png]]

我们先写 ColorPickerPanel 的部分：

![[2239d445650cc3513275331f5c402da1_MD5.png]]
...
```
![[a39b0b7ae4288ca16ead8b533855b78e_MD5.png]]
...
![[b8d3fd448ac8268b9e724951ddbfb0c0_MD5.png]]
...
![[6618f7ebf12179449d970698b7b97920_MD5.png]]
...
![[3f9048e3e9aebbfed63a094b7d5470eb_MD5.png]]
...
![[02fdc08192ba85cc2108372c10e4a385_MD5.png]]
```javascript
...
![[87d6ffe4e03c6695ecca424180802de9_MD5.png]]

调色板出来了。

还要实现上面的滑块，这个封装个组件，因为 Slider 也会用到：

![[6815b20deaae3315b5d69af6661bd4fa_MD5.png]]
...
![[2ddb44cf614d8a9deb116c87a102d629_MD5.png]]

加一下两种滑块的样式：

![[186d29c854a68777862a0939bc97eaac_MD5.png]]
...
![[0d9a8abcf656450378183ba9a43bc17a_MD5.png]]
...
![[b1ff04c1e818d467ad1122d67b671c60_MD5.png]]

只是现在看不到。

加一下 zindex 就好了：

![[022727048cf6660e84d51915386ff8d5_MD5.png]]

![[6d8df5a30bd41b885a39ac4fb8686bc8_MD5.png]]
...
![[d02c6b1c38cd492ad5cb063f23128e37_MD5.png]]
...
![[74df8106ebc9467b5134f89fc66765e4_MD5.png]]

如果不单独分 Transform 这个组件呢？

那就是把这段样式写在 Hanlder 组件里，然后加上俩参数：

![[a50c7f29c1e7c03081a6b8122763657f_MD5.png]]
...
![[81a19aeab60a40ca08ca30ef2e06d068_MD5.png]]

而在 jsx 里绑定事件，这时候 event 是 React.MouseEvent 类型：

![[6696f756e99bdefe42bb60fff44f4e98_MD5.png]]

我们都要支持：

![[ef2bedc389a9ac557bc3df0a16ce8a56_MD5.png]]

这两个 state 一个是保存 offset 的，一个是保存是否在拖动中的标记的：

![[3b9f582b7fc1d0ed2358f8a1a9e41f07_MD5.png]]

然后先把之前的事件监听器去掉：

![[c2a538f20bb0ed058cf27095e97a7575_MD5.png]]

在 mousedown 的时候绑定 mousemove 和 mouseup 事件：

![[d229d0f0cf17a03fe13fd7ce546be525_MD5.png]]
...
![[bbebf88c5443876208153b9223fdcb7b_MD5.png]]

我们来试下效果：

![[40039d2f28e71d2fec210f3cc2cf57b6_MD5.png]]
...
![[c8a50bc969965fcec25778556b5809fd_MD5.gif]]
...
![[3025ccc09d5ca4e69ad1841767e18408_MD5.png]]

在 ColorPickerPanel 组件里处理下 onChange：

![[fcecd2e0de8c5c9abfee8f182ab5d6ac_MD5.png]]
...
![[45d41dffea3485bded4206b9248055f4_MD5.gif]]

没啥问题。

只是现在初始的颜色不对：

![[ad4b757017f6ece44f87f890686ef98f_MD5.png]]

最开始也要计算一次滑块位置：

![[78b59619847810e68b18927ab88e6a82_MD5.png]]
...
![[4f08cfb3539ec69be4fcbac65ed00092_MD5.png]]
...
![[ca7ae1ddbfebb772b014b87c493ed33c_MD5.png]]

我在 App.tsx 里设置个不同的颜色：

![[94f5e9e4d1add9c58f8c0f5a9de0c01c_MD5.png]]
...
初始位置也是对的：
![[fd69c183a6d97b32ebc7b56d35b7eab7_MD5.png]]

我们在下面加一个颜色块：

![[33a326661fea42a7021c5de599bfb0fe_MD5.png]]

```html
<div style={{width: 20, height: 20, background: colorValue.toRgbString()}}></div>
```
![[5359b0a0ae4a5ee79225d39c2020ffce_MD5.gif]]

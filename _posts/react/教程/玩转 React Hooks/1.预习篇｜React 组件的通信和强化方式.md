...
Hooks 是 React v16.8 以后新增的 API，**目的**是增加代码的可复用性、逻辑性，**最主要的目的**是解决了函数式组件无状态的问题，这样既保留了函数式的简单，又解决了没有数据管理状态的缺陷。
...
源码：/Users/ll/Desktop/learn-notes/frontend/react/3rd/domesy-hooks

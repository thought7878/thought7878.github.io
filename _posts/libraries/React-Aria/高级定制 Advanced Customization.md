...
## Contexts[](https://react-spectrum.adobe.com/react-aria/advanced.html#contexts)  
上下文
...
每个 React Aria 组件都导出一个对应的上下文，您可以使用它来构建自己的组合 API，类似于内置组件。您可以通过上下文发送任何 prop 或 ref，并将其传递给相应的组件。组件上的本地 props 和 ref 与通过上下文传递的 props 和 ref 合并，本地 props 优先（遵循 [mergeProps](https://react-spectrum.adobe.com/react-aria/mergeProps.html) 中记录的规则）。
...
此示例显示一个呈现一组文本字段的 `FieldGroup` 组件。可以通过 `isDisabled` 属性将整个组标记为禁用，该属性通过 `TextFieldContext` 提供程序传递给所有子文本字段。
...
放置在 `FieldGroup` 中的任何 `TextField` 组件都将自动从组中接收 `isDisabled` 属性，包括那些深深嵌套在其他组件中的组件。
...
### Slots[#](https://react-spectrum.adobe.com/react-aria/advanced.html#slots)  
插槽[编号](https://react-spectrum.adobe.com/react-aria/advanced.html#slots)
...
#### Default slot[#](https://react-spectrum.adobe.com/react-aria/advanced.html#default-slot)  
默认插槽[编号](https://react-spectrum.adobe.com/react-aria/advanced.html#default-slot)
...
### Provider[#](https://react-spectrum.adobe.com/react-aria/advanced.html#provider)  
提供者[编号](https://react-spectrum.adobe.com/react-aria/advanced.html#provider)
...
### Consuming contexts[#](https://react-spectrum.adobe.com/react-aria/advanced.html#consuming-contexts)  
消费上下文 [#](https://react-spectrum.adobe.com/react-aria/advanced.html#consuming-contexts)
...
#### useContextProps[#](https://react-spectrum.adobe.com/react-aria/advanced.html#usecontextprops)
...
#### useSlottedContext[#](https://react-spectrum.adobe.com/react-aria/advanced.html#useslottedcontext)
...
### Accessing state[#](https://react-spectrum.adobe.com/react-aria/advanced.html#accessing-state)  
访问状态 [#](https://react-spectrum.adobe.com/react-aria/advanced.html#accessing-state)
...
## Hooks[#](https://react-spectrum.adobe.com/react-aria/advanced.html#hooks)  
挂钩[编号](https://react-spectrum.adobe.com/react-aria/advanced.html#hooks)
...
### Setup[#](https://react-spectrum.adobe.com/react-aria/advanced.html#setup)  
设置[编号](https://react-spectrum.adobe.com/react-aria/advanced.html#setup)
...
### Reusing children[#](https://react-spectrum.adobe.com/react-aria/advanced.html#reusing-children)  
重用儿童 [#](https://react-spectrum.adobe.com/react-aria/advanced.html#reusing-children)
...
### Examples[#](https://react-spectrum.adobe.com/react-aria/advanced.html#examples)  
实施例 [#](https://react-spectrum.adobe.com/react-aria/advanced.html#examples)

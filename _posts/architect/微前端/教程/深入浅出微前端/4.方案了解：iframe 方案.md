...
![[_posts/architect/微前端/教程/深入浅出微前端/media/97a49ff25ee23e0f3b2f18426e27133d_MD5.png]]
...
![[_posts/architect/微前端/教程/深入浅出微前端/media/777c8b0a3a0f5d9f11622ce192544c64_MD5.png]]

如果想要查看 Chrome 浏览器的进程运行情况，可以通过右上角的**设置 / 更多工具 / 任务管理器**打开：

![[_posts/architect/微前端/教程/深入浅出微前端/media/c1d81ea54ceefc9bde5360204a27171c_MD5.png]]

打开以后可以在任务管理器的列表中查看进程情况：

![[_posts/architect/微前端/教程/深入浅出微前端/media/45def78eccc23db1f919cb3dfa8f1b62_MD5.png]]

## 浏览器沙箱隔离

由于 Web 应用运行在 Renderer 进程中，浏览器为了提升安全性，需要通过常驻的 Browser 主进程对 Renderer 进程进行沙箱隔离设计，从而实现 Web 应用进行隔离和管控，如下所示：

![[_posts/architect/微前端/教程/深入浅出微前端/media/75bf9c64f5439caf72c0393d7ee67fa3_MD5.png]]
...
![[_posts/architect/微前端/教程/深入浅出微前端/media/71914adefa50537efc8375a65a762238_MD5.png]]
...
![[_posts/architect/微前端/教程/深入浅出微前端/media/daa97a359eee6fe93cc412b41d18bc7c_MD5.png]]
...
![[_posts/architect/微前端/教程/深入浅出微前端/media/ce47666de177f0d11d3ddf7644e6f248_MD5.png]]
...
![[_posts/architect/微前端/教程/深入浅出微前端/media/72ab255f977afd9b1a3c203c9d1f5050_MD5.png]]
...
![[_posts/architect/微前端/教程/深入浅出微前端/media/fa729fdc34d8503a4595957c23f4379f_MD5.png]]

为了查看同站 iframe 所在应用的进程，可以点击按钮使用 `window.open` 跳转新的标签页，此时可以发现 iframe 应用和 main 应用处于同一个 Renderer 进程中：

![[_posts/architect/微前端/教程/深入浅出微前端/media/2737cc0493134edb0c314935dd4fea77_MD5.png]]

浏览器的站点隔离功能是可以关闭的，通过 `chrome://flags` 进入：

![[_posts/architect/微前端/教程/深入浅出微前端/media/230e1df16dff8a1db10ee593d52ae5d8_MD5.png]]

禁用站点隔离后，可以发现主应用和两个 iframe 应用处于同一个 Renderer 进程：

![[_posts/architect/微前端/教程/深入浅出微前端/media/0200967aa2df7e48a3cb8588a6b5367b_MD5.png]]
...
![[_posts/architect/微前端/教程/深入浅出微前端/media/4073cfb62b6daabd3ad2f264906e8e66_MD5.png]]
...
![[_posts/architect/微前端/教程/深入浅出微前端/media/b9d0989e14c6772216331197a4c029ff_MD5.png]]

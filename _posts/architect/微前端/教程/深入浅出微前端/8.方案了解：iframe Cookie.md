...
![[_posts/architect/微前端/教程/深入浅出微前端/media/06689d37d0b637e4154ded958cc97508_MD5.png]]
...
![[_posts/architect/微前端/教程/深入浅出微前端/media/bab8d638e59ebb0ab7b9539692249328_MD5.gif]]
...
![[_posts/architect/微前端/教程/深入浅出微前端/media/a2e79e7cbda88bd28ba4dcdde8b8abc4_MD5.png]]

> 温馨提示：iHosts 工具本质上是更改了本地系统的 hosts 文件，从而起到域名和 IP 的匹配映射。这里可以额外了解本地 hosts 匹配和 DNS 服务解析的差异。

在 iHosts 中同一个 IP 地址可以指向不同的域名，配置如下所示：

![[_posts/architect/微前端/教程/深入浅出微前端/media/3e2c56ed248dfd4493f610eab10cf527_MD5.png]]
...
![[_posts/architect/微前端/教程/深入浅出微前端/media/afa4bc70f2726bd3dff0a9ebe20a3d49_MD5.gif]]
...
![[_posts/architect/微前端/教程/深入浅出微前端/media/b13fa8eee4a4e6188573318a93808379_MD5.png]]

-   在主应用中使用 iHosts 进行域名映射，将 `ziyi.com` 映射到本地 IP 地址
-   在子应用中使用 iHosts 进行域名映射，将 `ziyi.example.com` 映射到本地 IP 地址

![[_posts/architect/微前端/教程/深入浅出微前端/media/868496ad4ff46b289f12db0a680d0e64_MD5.png]]

此时主子应用因为 eTLD + 1 不同形成跨站（`com` 是一个有效顶级域名），由于 iHosts 映射的 IP 地址不变，因此不需要将将主子应用的 Node 服务断开，重新在浏览器中通过 `ziyi.com:4000` 进行访问，如下所示：

![[_posts/architect/微前端/教程/深入浅出微前端/media/4d65b777826bf3f722450c4d74fb76fa_MD5.gif]]
...
![[_posts/architect/微前端/教程/深入浅出微前端/media/a2bce923d05f71168ce7392c29367936_MD5.png]]
...
![[_posts/architect/微前端/教程/深入浅出微前端/media/b81efa2b37dc6b379831a916727ff057_MD5.png]]
...
![[_posts/architect/微前端/教程/深入浅出微前端/media/062884e2bf4477f90d279434a6011e4c_MD5.png]]
...
![[_posts/architect/微前端/教程/深入浅出微前端/media/2926fc4ee9639cf1dc4d5af52f295380_MD5.gif]]
...
![[_posts/architect/微前端/教程/深入浅出微前端/media/3204232f59f955defe485671e79f28ac_MD5.gif]]

...
![[_posts/architect/微前端/教程/深入浅出微前端/media/6b3ae4221a38b4d59b8316091e1c9687_MD5.jpg]]

实现效果如下所示，点击按钮后会请求微应用的静态资源并解析 JS 和 CSS：

![[_posts/architect/微前端/教程/深入浅出微前端/media/21b2859734ec7d7a89342a6fb84f5b0e_MD5.gif]]

...
**Journals 插件** 是 Obsidian 的一款社区插件，专为*创建和管理日记（Journals）* 设计。它可以帮助用户*自动生成每日、每周、每月的日记文件*，并支持灵活的模板配置。通过 Journals 插件，你可以*轻松地记录日常生活、管理工作任务、进行知识整理*。

Journals 插件的**核心功能**是自动化日记生成和组织，特别适合需要长期坚持写日记或定期记录内容的用户。

...
![[_posts/网络/HTTP/media/70150335b6889e3df2bed2567c10f356_MD5.jpeg]]
...
![[_posts/网络/HTTP/media/b673e40c3f6169a84b281dbe384cfb9e_MD5.jpeg]]
...
- **结构**：
  ...
  - *消息被分成更小的单元*，称为`帧（Frame）`
- **优点**：
  - *提高了解析效率，减少了错误率*。
  - 支持更复杂的协议功能（如多路复用和优先级）。

![[_posts/网络/HTTP/media/34def57f08b09fcdec0e5503079dde56_MD5.jpeg]]

![[_posts/网络/HTTP/media/0b93081485084e1b4408d62707e23883_MD5.jpeg]]
...
### 4. 服务器推送（Server Push）*
- **定义**：
  - 服务器可以*主动向客户端推送资源，而无需等待客户端发起请求*。**允许对客户端请求进行多次响应，服务器可以发送额外资源**。
- **应用场景**：
...
![[_posts/网络/HTTP/media/49e2b0efb7b1d9c012d9384c7e8b9bb7_MD5.jpeg]]
...
### 5. 优先级（Prioritization）*
- **定义**：
  - 客户端可以*为请求设置优先级，指示服务器优先传输关键资源*。
- **实现方式**：
  - 每个流（Stream）都有一个权重值和依赖关系，用于确定优先级。
- **优点**：
  - 优化了关键资源的加载顺序，提升了用户体验。

![[_posts/网络/HTTP/media/ee662034c375b7c0e3446953d0564bd1_MD5.jpeg]]
